      ...
      <View style={styles.content}>
        <View style={styles.zprofil}>
          <View style={styles.pic}>
            ...
            <TouchableOpacity id='pen' style={styles.pen}>
              <Image
...
const styles = StyleSheet.create({
  content:{position:'fixed',marginTop:40,width:'100%',height:'100%',paddingBottom:80,backgroundColor:Colors.white,flexDirection:'column',gap:'3%',justifyContent:'center'},
  zprofil:{gap:10},
