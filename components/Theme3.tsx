    ...
    return (
      <>
        ...
        <View style={styles.background}>
          <Image
            source={require('@/assets/images/Fonden-degrade3.png')}
            style={styles.img}
          />
        </View>
        ...
        <ScrollView style={styles.contain}>
            <View style={styles.top}>
                ...
                <View>
                <TouchableOpacity onPress={() => router.push("/home2")} style={styles.start}>
                    <Image
            ...
            <View style={styles.containt}>
                <View style={styles.containt}>
                    <View style={styles.river}>
                        <Image
                            source={require('@/assets/images/Forme3.png')}
                            style={styles.img}
                        />
                    </View>
                    <View style={styles.grad}>
                        <View style={[styles.el, styles.flexstar]}>
                            <TouchableOpacity onPress={() => router.push("/home2")} style={[styles.btn]}>
                                <View style={styles.part}>
                                    <Image
                                        source={require('@/assets/images/obB1.png')}
                                        style={styles.img}
                                    />
                                </View>
                        ...
                        <View style={[styles.el, styles.flexcenter]}>
                            <TouchableOpacity onPress={() => router.push("/home2")} style={[styles.btn]}>
                                <View style={styles.part}>
                                    <Image
                                        source={require('@/assets/images/obc2.png')}
                                        style={styles.img}
                                    />
                                </View>
